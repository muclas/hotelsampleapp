...
{
    [TestFixture]
    public class BillTests : BDDTest<BillAggregate>
    {
        private Guid testId;
        ...
        [Test]
        public void CanNotOrderWithUnopenedBill()
        {
            Test(
                Given(),
                When(new PlaceOrder
        ...
        [Test]
        public void CanCloseBillByPayingExactAmount()
        {
            Test(
                Given(new BillOpened
                {
